...
#pragma region 증감 연산자
	...
	//result = ++data; // result : result : 1 <- data : 1
	//result = data--; // result : result : 1 <- data : 0 

	//printf("data의 값 : %d\n", data);
	//printf("result의 값 : %d\n", result);

	//result = data++; // result : result : 0 <- data : 1
	//result = --data; // result : result : 0 <- data : 0
