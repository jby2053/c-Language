...
#pragma region 명시적 형 변환
	...
	// 정수형 변수 끼리 연산을 수행하게 되면 정수의
	// 결과값만 가질 수 있습니다.

#pragma region 쉬프트 연산자
	...
	//
	//                                                   
	//printf("data 변수를 왼쪽 2번 시프트 연산한 결과 : %d", data <<= 2); // 0010 1000
	//printf("data 변수의 값 : %d\n", data); // 0010 1000(40)

	//printf("data 변수를 오른쪽으로 3번 시프트 연산한 결과 : %d\n", data >>= 3); // 0000 0001
	//printf("data 변수의 값 : %d\n", data); // 0000 1010
#pragma endregion

#pragma region  부호 없는 자료형
//	// 부호 비트를 제거하여 저장 가능한
//	// 양수의 범위를 2배 늘리는 자료형입니다.
//
