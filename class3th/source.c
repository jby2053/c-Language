...
#pragma region 실수를 저장하는 방법
	...
	// 가수부에 있는 비트 중에서 가장 완쪽에 있는 수는 표현하지 않습니다.
	//double health = 6.25;
...
#pragma region 관계 연산자
	...
	//int result2 = 10 < 5;  // 10 < 5 : 5이 10보다 크다. (거짓)
	//int result3 = 10 >= 5; // 10 >= 5 : 10이 5 보다 크거나 같다 (참)
	//int result4 = 10 <= 5; // 10 <= 5 : 5이 10 보다 크거나 같다 (거짓)
...
//}
// SWITCH 문에는 조건식으로 실수형 변수와 실수형 상수를 사
